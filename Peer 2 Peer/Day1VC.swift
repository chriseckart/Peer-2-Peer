...
class Day1VC: UITableViewController, SendDataDelegate {
...
//                    print("current classTitle is ", classTitle)
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        switch indexPath.row {
        case 0: selectedBlock = "ClassA"
        case 1: selectedBlock = "ClassE"
        case 2: selectedBlock = "ClassG"
        case 3: selectedBlock = "ClassC"
        default: break
        }
        performSegue(withIdentifier: "Day1ToSubjectSegue", sender: self)
    }
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "Day1ToSubjectSegue"{
