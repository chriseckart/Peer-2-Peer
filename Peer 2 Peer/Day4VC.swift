...
class Day4VC: UITableViewController, SendDataDelegate {
...
//                    print("current classTitle is ", classTitle)
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        switch indexPath.row {
        case 0: selectedBlock = "ClassD"
        case 1: selectedBlock = "ClassH"
        case 2: selectedBlock = "ClassF"
        case 3: selectedBlock = "ClassB"
        default: break
        }
        performSegue(withIdentifier: "Day4ToSubjectSegue", sender: self)
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "Day4ToSubjectSegue"{
